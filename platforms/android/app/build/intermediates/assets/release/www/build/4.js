...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__specialoffers__ = __webpack_require__(718);
...
var SpecialoffersPage = /** @class */ (function () {
    ...
    SpecialoffersPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-specialoffers',template:/*ion-inline-start:"G:\Angular\Cozyorder\CozyOrders\src\pages\specialoffers\specialoffers.html"*/'<ion-header>\n    <ion-navbar>\n      <button ion-button menuToggle>\n        <ion-icon name="menu"></ion-icon>\n      </button>\n      <ion-buttons>\n        <button ion-button icon-only>\n          <ion-label class="open-page-title">Special Offers</ion-label>    \n        </button>\n        </ion-buttons>\n  \n      <ion-buttons end>\n      <button ion-button  icon-only class="top-nav-search" (click)="goToSearch()">\n        <ion-icon  name="search"></ion-icon>\n      </button>\n    </ion-buttons>\n    </ion-navbar>\n  </ion-header>'/*ion-inline-end:"G:\Angular\Cozyorder\CozyOrders\src\pages\specialoffers\specialoffers.html"*/,
        }),
