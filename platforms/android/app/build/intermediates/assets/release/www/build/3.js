...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__support__ = __webpack_require__(722);
...
var SupportPage = /** @class */ (function () {
    ...
    SupportPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-support',template:/*ion-inline-start:"G:\Angular\Cozyorder\CozyOrders\src\pages\support\support.html"*/'<ion-header>\n    <ion-navbar>\n      <button ion-button menuToggle>\n        <ion-icon name="menu"></ion-icon>\n      </button>\n      <ion-buttons>\n        <button ion-button icon-only>\n          <ion-label class="open-page-title">Support</ion-label>    \n        </button>\n        </ion-buttons>\n  \n      <ion-buttons end>\n      <button ion-button  icon-only class="top-nav-search" (click)="goToSearch()">\n        <ion-icon  name="search"></ion-icon>\n      </button>\n    </ion-buttons>\n    </ion-navbar>\n  </ion-header>'/*ion-inline-end:"G:\Angular\Cozyorder\CozyOrders\src\pages\support\support.html"*/,
        }),
