...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__search__ = __webpack_require__(730);
...
var SearchPage = /** @class */ (function () {
    ...
    SearchPage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["n" /* Component */])({
            selector: 'page-search',template:/*ion-inline-start:"G:\Angular\CozyOrderResto\src\pages\search\search.html"*/'\n  <ion-header>\n      <ion-navbar >\n   \n        <ion-buttons (click)="presentProfileModal()" class="selected-location">\n          <button ion-button icon-only>\n            <ion-label class="selected-location-title">Madhapur, iLabs, 4th Floor  </ion-label>    \n            <ion-icon end name="arrow-dropdown"></ion-icon>\n          </button>\n          </ion-buttons>\n         </ion-navbar>\n          <ion-navbar>\n          <ion-searchbar placeholder="Search Restaurant,Food Item" showCancelButton color="danger" (ionInput)="filterItems($event)"></ion-searchbar>\n        </ion-navbar>\n    </ion-header>\n  <ion-content>  \n     \n         <div class="recent-search-list">\n           <h2>   Recent Searches</h2>\n         <button ion-item>\n            <ion-label>Family Checken Biryani</ion-label>\n          </button>\n\n          <button ion-item>\n              <ion-label>Thick Shake Factory</ion-label>\n            </button>\n          </div>\n      \n\n   <ion-list>\n      <ion-item *ngFor="let item of items">\n        {{ item }}\n      </ion-item>\n    </ion-list>\n  \n  </ion-content>\n  \n\n  '/*ion-inline-end:"G:\Angular\CozyOrderResto\src\pages\search\search.html"*/,
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["l" /* NavController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["m" /* NavParams */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* ModalController */], __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["r" /* ViewController */]])
    ], SearchPage);
    return SearchPage;
}());
